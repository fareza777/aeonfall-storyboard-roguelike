...
void main() {
  ...
  // Subscribe to Play Billing before returning the widget tree so a pending
  // non-consumable can be delivered after a process restart.
  MonetizationService.i.start();
